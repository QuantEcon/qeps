...
**If the QEP's Adoption section obligates repositories other than this one**, create
`QuantEcon/project-qep{N}` (private; `N` unpadded) in the same sitting, open its
